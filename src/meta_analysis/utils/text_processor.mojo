"""
Text processing utilities for meta-analysis framework.

This module provides utility functions for processing and analyzing text
content within the meta-analysis framework.
"""
